...
p={
"image_name":"epic_graph",
"branch":"main",
"docker_registry":"harbor.xcr.svcs01eu.prod.eu-central-1.kaas.sws.siemens.com/eps",
"code_repository":"https://github.com/mahmad2504/epic_graph.git"
}
...
arg_desc = '''\
        This program Generates Epic Reports!
        --------------------------------
...
parser.add_argument('--epic',   help='epic name required for generate command')
